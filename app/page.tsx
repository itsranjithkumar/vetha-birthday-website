...
export default function Page() {
  ...
  return <main className={`birthday-app scene-${scene}`}>
    ...
    {scene === 'intro' && <section className="scene-content intro-content"><div className="intro-lines"><p>Oiii madam 👀</p></div><button className="outline-button" onClick={() => setScene('message')}>Ready ah? <span aria-hidden="true">→</span></button></section>}
